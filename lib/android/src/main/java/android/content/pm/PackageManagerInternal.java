...
public abstract class PackageManagerInternal {
     ...
     */
    public abstract void requestInstantAppResolutionPhaseTwo(Object responseObj,
     ...
     */
    public abstract Object getPackageList(PackageListObserver observer);
     ...
     */
    public abstract PackageParser.Package getDisabledPackage(String packageName);
     ...
     */
    public abstract String getKnownPackageName(
    ...
    public abstract boolean filterAppAccess(PackageParser.Package pkg, int callingUid, int userId);
     ...
     */
    public abstract int getPermissionFlagsTEMP(String permName,
                                               String packageName, int userId);

    /**
     * Updates the flags for the given permission.
     */
    public abstract void updatePermissionFlagsTEMP(String permName,
                                                   String packageName, int flagMask, int flagValues, int userId);
     ...
     */
    public abstract boolean isDataRestoreSafe(byte[] restoringFromSigHash,
                                              String packageName);
     ...
     */
    public abstract boolean isDataRestoreSafe(Signature restoringFromSig,
                                              String packageName);
